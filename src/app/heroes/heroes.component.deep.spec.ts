...
// Create a mock RouterLink directive stub
@Directive({
...
describe('HeroesComponent (deep tests)', () => {
  ...
  it('should have the correct route for the first Hero /1', () => {
    mockHeroService.getHeroes.and.returnValue(of(HEROES));

    // Trigger ngOnInit
    fixture.detectChanges();
    const heroComponents: DebugElement | any = fixture.debugElement.queryAll(By.directive(HeroComponent));
